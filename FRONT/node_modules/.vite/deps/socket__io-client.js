...
function xmlhttprequest_browser_default(opts) {
  ...
  try {
    if ("undefined" !== typeof XMLHttpRequest && (!xdomain || import_has_cors.default)) {
...
var WS = class _WS extends Transport {
  /**
   ...
   */
  check() {
    return !!WebSocket && !("__initialize" in WebSocket && this.name === _WS.prototype.name);
  }
};
...
var import_component_emitter4 = __toESM(require_component_emitter());
