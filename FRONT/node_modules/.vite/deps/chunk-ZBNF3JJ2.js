...
var require_baseRest = __commonJS({
  "node_modules/lodash/_baseRest.js"(exports, module) {
    ...
    function baseRest(func, start3) {
      return setToString(overRest(func, start3, identity4), func + "");
    }
...
function basis(t14, v0, v1, v22, v3) {
  ...
  return ((1 - 3 * t14 + 3 * t22 - t32) * v0 + (4 - 6 * t22 + 3 * t32) * v1 + (1 + 3 * t14 + 3 * t22 - 3 * t32) * v22 + t32 * v3) / 6;
}
...
var rgb_default = function rgbGamma(y4) {
  ...
  function rgb4(start3, end) {
    var r4 = color2((start3 = rgb2(start3)).r, (end = rgb2(end)).r), g2 = color2(start3.g, end.g), b3 = color2(start3.b, end.b), opacity = nogamma(start3.opacity, end.opacity);
    return function(t6) {
      start3.r = r4(t6);
      start3.g = g2(t6);
      start3.b = b3(t6);
...
function rgbSpline(spline) {
  return function(colors3) {
    var n3 = colors3.length, r4 = new Array(n3), g2 = new Array(n3), b3 = new Array(n3), i3, color2;
    for (i3 = 0; i3 < n3; ++i3) {
...
function genericArray(a3, b3) {
  ...
  for (i3 = 0; i3 < na; ++i3)
    x4[i3] = value_default(a3[i3], b3[i3]);
  for (; i3 < nb; ++i3)
    c8[i3] = b3[i3];
  return function(t6) {
    for (i3 = 0; i3 < na; ++i3)
...
function value_default(a3, b3) {
  var t6 = typeof b3, c8;
  return b3 == null || t6 === "boolean" ? constant_default(b3) : (t6 === "number" ? number_default : t6 === "string" ? (c8 = color(b3)) ? (b3 = c8, rgb_default) : string_default : b3 instanceof color ? rgb_default : b3 instanceof Date ? date_default : isNumberArray(b3) ? numberArray_default : Array.isArray(b3) ? genericArray : typeof b3.valueOf !== "function" && typeof b3.toString !== "function" || isNaN(b3) ? object_default : number_default)(a3, b3);
}
...
function hsl3(hue2) {
  return function(start3, end) {
    var h2 = hue2((start3 = hsl2(start3)).h, (end = hsl2(end)).h), s3 = nogamma(start3.s, end.s), l3 = nogamma(start3.l, end.l), opacity = nogamma(start3.opacity, end.opacity);
    return function(t6) {
      start3.h = h2(t6);
      start3.s = s3(t6);
      start3.l = l3(t6);
...
function hcl2(hue2) {
  return function(start3, end) {
    var h2 = hue2((start3 = hcl(start3)).h, (end = hcl(end)).h), c8 = nogamma(start3.c, end.c), l3 = nogamma(start3.l, end.l), opacity = nogamma(start3.opacity, end.opacity);
    return function(t6) {
      start3.h = h2(t6);
      start3.c = c8(t6);
      start3.l = l3(t6);
...
function cubehelix2(hue2) {
  return function cubehelixGamma(y4) {
    ...
    function cubehelix3(start3, end) {
      var h2 = hue2((start3 = cubehelix(start3)).h, (end = cubehelix(end)).h), s3 = nogamma(start3.s, end.s), l3 = nogamma(start3.l, end.l), opacity = nogamma(start3.opacity, end.opacity);
      return function(t6) {
        start3.h = h2(t6);
        start3.s = s3(t6);
...
function normalizeColor2(color2) {
  ...
  if (match = hex62.exec(color2))
    return parseInt(match[1] + "ff", 16) >>> 0;
  if (colors$12 && colors$12[color2] !== void 0) {
    return colors$12[color2];
  }
...
function transformer() {
  var domain = unit, range = unit, interpolate3 = value_default, transform, untransform, unknown, clamp = identity2, piecewise2, output, input;
  function rescale() {
  ...
  function scale(x4) {
    return x4 == null || isNaN(x4 = +x4) ? unknown : (output || (output = piecewise2(domain.map(transform), range, interpolate3)))(transform(clamp(x4)));
  }
...
function quantize() {
  ...
  function scale(x4) {
    return x4 != null && x4 <= x4 ? range[bisect_default(domain, x4, 0, n3)] : unknown;
  }
  function rescale() {
    var i3 = -1;
    domain = new Array(n3);
...
function ticker(year3, month3, week, day3, hour3, minute3) {
  ...
  function tickInterval(start3, stop2, count2) {
    ...
    if (i3 === tickIntervals.length)
      return year3.every(tickStep(start3 / durationYear, stop2 / durationYear, count2));
    if (i3 === 0)
...
var day2 = newInterval2(function(date2) {
  ...
  return (end - start3 - (end.getTimezoneOffset() - start3.getTimezoneOffset()) * durationMinute2) / durationDay2;
}, function(date2) {
...
function cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
  var x01 = x0 - x1, y01 = y0 - y1, lo = (cw ? rc : -rc) / sqrt2(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x0 + ox, y11 = y0 + oy, x10 = x1 + ox, y10 = y1 + oy, x00 = (x11 + x10) / 2, y00 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d2 = dx * dx + dy * dy, r4 = r1 - rc, D2 = x11 * y10 - x10 * y11, d3 = (dy < 0 ? -1 : 1) * sqrt2(max2(0, r4 * r4 * d2 - D2 * D2)), cx0 = (D2 * dy - dx * d3) / d2, cy0 = (-D2 * dx - dy * d3) / d2, cx1 = (D2 * dy + dx * d3) / d2, cy1 = (-D2 * dx + dy * d3) / d2, dx0 = cx0 - x00, dy0 = cy0 - y00, dx1 = cx1 - x00, dy1 = cy1 - y00;
...
function line_default() {
  var x4 = x, y4 = y, defined = constant_default3(true), context = null, curve = linear_default, output = null;
  function line(data) {
...
function stack_default() {
  ...
  stack.keys = function(_) {
    return arguments.length ? (keys = typeof _ === "function" ? _ : constant_default3(slice2.call(_)), stack) : keys;
  };
  stack.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : constant_default3(+_), stack) : value;
  };
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? none_default2 : typeof _ === "function" ? _ : constant_default3(slice2.call(_)), stack) : order;
  };
...
var at = function(e4) {
  if ((0, import_isFunction.default)(e4)) {
    if (!(0, import_isFunction.default)(e4.domain))
      throw new Error("Provided colors should be a valid quantize scale providing a 'domain()' function");
    return e4;
  }
  if (nt[e4])
    return quantize().range(nt[e4]);
  if ((0, import_isArray.default)(e4))
    return quantize().range(e4);
  throw new Error("Unable to guess quantize color scale from '" + e4 + "',\nmust be a function or one of:\n'" + ot.join("', '") + "'");
};
...
var g = (0, import_react9.memo)(function(t6) {
  var o3, n3 = t6.position, r4 = t6.anchor, e4 = t6.children, l3 = Vt(), u2 = tt(), p2 = u2.animate, f2 = u2.config, g2 = Ft(), b3 = g2[0], w2 = g2[1], T2 = (0, import_react9.useRef)(false), C4 = void 0, E3 = false, P3 = w2.width > 0 && w2.height > 0, N2 = Math.round(n3[0]), V2 = Math.round(n3[1]);
  P3 && ("top" === r4 ? (N2 -= w2.width / 2, V2 -= w2.height + 14) : "right" === r4 ? (N2 += 14, V2 -= w2.height / 2) : "bottom" === r4 ? (N2 -= w2.width / 2, V2 += 14) : "left" === r4 ? (N2 -= w2.width + 14, V2 -= w2.height / 2) : "center" === r4 && (N2 -= w2.width / 2, V2 -= w2.height / 2), C4 = { transform: m2(N2, V2) }, T2.current || (E3 = true), T2.current = [N2, V2]);
  var j2 = useSpring({ to: C4, config: f2, immediate: !p2 || E3 }), O4 = v2({}, x3, l3.tooltip, { transform: null != (o3 = j2.transform) ? o3 : m2(N2, V2) });
...
var C3 = (0, import_react9.memo)(function(t6) {
...
var E2 = (0, import_react9.memo)(function(t6) {
...
var F = function() {
  var t6 = z();
  return A2(t6) ? (0, import_jsx_runtime2.jsx)(g, { position: t6.position, anchor: t6.anchor, children: t6.content }) : null;
};
var M = function(t6) {
...
//# sourceMappingURL=chunk-ZBNF3JJ2.js.map
